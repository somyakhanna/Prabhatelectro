...
<body>
    ...
    <div class="container product">
        ...
        <h1 class="productheading">Convention Lighting </h1>
...
$data="select * from mainproducts where type='Convention'";
...
echo "
      ...
      <div class='h1'><a href='conproduct.php?tid=$id'><img src='img/$name' class='img-responsive' id='pimg'></a></div>
      <div class='h2'>
