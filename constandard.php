...
$data="select * from convention where id='$_GET[pid]]'";
...
?>
    ...
    <div class="container" style="width:70%;"  ><div class="row">
            <?php $data3="select name from mainproducts where id='$typeid'";
...
echo"
            ...
            <h4>Category: <a href='conproduct.php?tid=$typeid'>$category </a></h4>";?>
            <h4>Size:</h4>
            <h4>Description:</h4>
            <br>
