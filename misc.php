...
<body>
    ...
    <div class="container product">
        ...
        <h1 class="productheading">Miscellaneous Products</h1>
...
$data="select * from mainproducts where type='misc'";
...
echo "
      ...
      <div class='h1'><a href='miscproduct.php?tid=$id'><img src='img/$name' class='img-responsive' id='pimg'></a></div>
      <div class='h2'>
