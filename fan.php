...
<body>
    ...
    <div class="container product">
        ...
        <h1 class="productheading">Fan Parts</h1>
...
$data="select * from mainproducts where type='fan'";
...
echo "
      ...
      <div class='h1'><a href='fanproduct.php?tid=$id'><img src='img/$name' class='img-responsive' id='pimg'></a></div>
      <div class='h2'>
