...
<body>
    ...
    <div class="container product">
        ...
        <h1 class="productheading">Storage Racks</h1>
...
$data="select * from mainproducts where type='storage racks'";
...
echo "
      ...
      <div class='h1'><a href='cablestandard.php?tid=$id'><img src='img/$name' class='img-responsive' id='pimg'></a></div>
      <div class='h2'>
