...
<body>
    ...
    <div class="container product">
        ...
        <h1 class="productheading">MCB & TPN Boxes </h1>
...
$data="select * from mainproducts where type='MCB'";
...
echo "
      ...
      <div class='h1'><a href='mcbproduct.php?tid=$id'><img src='img/$name' class='img-responsive' id='pimg'></a></div>
      <div class='h2'>
