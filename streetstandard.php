...
include("db/config.php");
                  $s=$_GET['sid'];
                  $data2="select Name from ledstreetlight where id='$s'";
$run2=mysqli_query($conn,$data2);


while($row_ig=mysqli_fetch_array($run2))
{$name=$row_ig[0];
echo"
...
?>
    ...
    <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
            <?php
include("db/config.php");
$data="select * from ledstreetlight where id='$_GET[sid]'";
	...
	$pic1=$row_img[2];
        ...
        echo " 
            ...
            <div>
                ...
                <img data-u='image' src='img/$pic1' class='img-responsive primg' />
                <img data-u='thumb' src='img/$pic1' class='img-responsive primg'/>
            </div>
            <div>
                
                <img data-u='image' src='img/$pic2' class='img-responsive primg'/>
                <img data-u='thumb' src='img/$pic2' class='img-responsive primg' />
            </div>
            <div>
                
                <img data-u='image' src='img/$pic3' class='img-responsive primg'/>
                <img data-u='thumb' src='img/$pic3'class='img-responsive primg' />
            </div>
           <div>
                
                <img data-u='image' src='img/$pic4' class='img-responsive primg'/>
                <img data-u='thumb' src='img/$pic4' class='img-responsive primg' />
            </div>";
...
?>
    ...
    <br>
    <br>
    <div class="container" style="width:70%;"  ><div class="row">
           
            <?php $data3="select name from led where id='$typeid'";
$run3=mysqli_query($conn,$data3);

$row_type= mysqli_fetch_array($run3);
        $category=$row_type[0];
     ...
     echo"
            ...
            <h4>Category: <a href='ledstandard.php?pid=$typeid'>$category </a></h4>";?>
            <h4>Size:</h4>
            <h4>Description:</h4>
            <br>
